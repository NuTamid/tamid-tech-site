...
//         <h2 className="text-left text-white text-xl mb-10 mt-10 mx-auto px-8 lg:px-48">With over 300 hours of professional experience, our team at TAMID Tech excels in delivering innovative, data-driven solutions to meet diverse business needs</h2> 
...
const TestimonialSlider: React.FC<TestimonialSliderProps> = ({ title, testimonials }) => {
  return (
    <div className="text-center">
      <h2 className="text-left text-white text-5xl font-semibold mb-5 mt-5 mx-auto px-8 lg:px-48">{title}</h2>
      <div className="flex flex-wrap justify-center">
        {testimonials.map((t, i) => (
          <div key={i} className="flex flex-col items-center mx-4 my-8">
            <div
              ...
              className="flex justify-center items-center w-52 h-66 md:w-64 md:h-68 rounded-xl border border-opacity-25 bg-white bg-opacity-5 shadow-lg hover:bg-opacity-20 hover:scale-110 duration-300"
            >
              <img src={t.imageSrc} alt={`Picture of ${t.name}`} className="w-[95%] h-[95%]" />
            </div>
            <p className="font-bold text-white text-lg mt-4">{t.name}</p>
...
const InfiniteSlider1: React.FC = () => {
  const testimonials: Testimonial[] = [
    {
      border: "#11AEF1",
      imageSrc: "/Kevin Headshot.jpg",
      name: "Kevin Polackal",
      title: "TCF Instructor",
      text: "#ADBCC2",
    },
...
const InfiniteSlider2: React.FC = () => {
  const testimonials: Testimonial[] = [
    {
      border: "#FC9639",
      imageSrc: "/Jacob Headshot.jpeg",
...
const InfiniteSlider3: React.FC = () => {
  const testimonials: Testimonial[] = [
    {
      border: "#FC9639",
      imageSrc: "/DSC_9012.jpg",
...
const InfiniteSlider4: React.FC = () => {
  const testimonials: Testimonial[] = [
    {
      border: "#11AEF1",
      imageSrc: "/Megan Headshot.jpg",
      name: "Meggan Shvartsberg",
      title: "Developer",
      text: "#ADBCC2",
    },
...
const TeamPage: React.FC = () => {
  return (
    <>
      <main>
        <h1 className="text-left text-white text-5xl font-semibold mb-5 mt-5 mx-auto px-8 lg:px-48">
          Our Team & Projects
        </h1>
        <h2 className="text-left text-white text-xl mb-10 mt-10 mx-auto px-8 lg:px-48">
          With over 300 hours of professional experience, our team at TAMID Tech excels in delivering innovative, data-driven solutions to meet diverse business needs.
        </h2>
